...
public class shoppingList {
    public static void main(String[] args) {
        ...
        while (!command.equals("Go Shopping!")) {
            ...
            switch (input) {
                case "Urgent":
                    String addProduct = commandLine[1];
                    if (!shoppingList.contains(addProduct)) {
                        shoppingList.add(0,addProduct);
                    }
                    break;
                case "Unnecessary":
                    String removeProduct = commandLine[1];
                    shoppingList.remove(removeProduct);
                    break;
                case "Correct":
                    String oldProduct = commandLine[1];
                    String newProduct = commandLine[2];
                    if (shoppingList.contains(oldProduct)) {
                        ...
                        break;
                        case "Rearrange":
                            String rearrangeProduct = commandLine[1];
